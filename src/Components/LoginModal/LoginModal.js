...
export const LoginModal = ({ providers }) => {
	return (
		<div className="py-6 inset-0 bg-gray-900 bg-opacity-70 absolute z-50 flex justify-center items-center">
			<div className="flex bg-white rounded-lg shadow-lg overflow-hidden mx-auto  w-9/12 lg:max-w-4xl">
				{/* For Image beside login */}
				...
				<div className="w-full p-8 lg:w-1/2">
					...
					<button className="flex items-center justify-center mt-4 text-white rounded-lg shadow-md hover:bg-gray-100" onClick={()=>signIn('google')}>
